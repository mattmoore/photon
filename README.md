...
cd photon
makepkg
sudo pacman -U photon-0.1.8-1-x86_64.pkg.tar.xz
```
...
```shell
# Install
curl -LO https://github.com/mattmoore/photon/releases/download/0.1.8/photon_0.1.8-1_amd64.deb
sudo dpkg -i photon_0.1.8-1_amd64.deb
...
curl -LO https://github.com/mattmoore/photon/releases/download/0.1.8/photon-0.1.8-1.fc26.x86_64.rpm

## Fedora
# Install
sudo dnf install -y photon-0.1.8-1.fc26.x86_64.rpm
# Uninstall
sudo dnf remove -y photon

## openSUSE
# Install
sudo zypper in ./photon-0.1.8-1.fc26.x86_64.rpm
# Uninstall
